...
%token IF ELSE FOR WHILE DO BREAK CONTINUE RETURN NOT SWITCH CASE DEFAULT
%token INT FLOAT VOID PRINT PRINTLN
%token ID LCURL RCURL LPAREN RPAREN SEMICOLON COMMA LTHIRD RTHIRD
%token ADDOP MULOP RELOP ASSIGNOP INCOP DECOP LOGICOP
%token CONST_INT CONST_FLOAT CHAR DOUBLE
